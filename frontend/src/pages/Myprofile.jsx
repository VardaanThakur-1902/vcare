    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>

      {
        ...
        ? <label htmlFor='image'>
            <div className='inline-block relative cursor-pointer'>
              ...
              <img className='w-10 absolute bottom-12 right-12' src={image ? undefined : assets.upload_icon} alt="" />
            </div>
      ...
      <div>
        ...
        : <p className='text-gray-400'>{userData.gender}</p>
          ...
          {
            isEdit 
            ? <input className='max-w-28 bg-gray-100' type="date" onChange={e => setUserData(prev => ({...prev,dob:e.target.value}))} value={userData.dob === 'Not Selected' ? '' : userData.dob}/>
